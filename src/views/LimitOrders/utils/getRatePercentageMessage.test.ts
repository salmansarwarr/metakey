...
const ONE_USDT_PER_CAKE = new Price(CAKE, USDT, EIGHTEEN_DECIMALS, ONE)
const FIVE_USDT_PER_CAKE = new Price(CAKE, USDT, EIGHTEEN_DECIMALS, FIVE)
const SEVEN_USDT_PER_CAKE = new Price(CAKE, USDT, EIGHTEEN_DECIMALS, SEVEN)
const ELEVEN_USDT_PER_CAKE = new Price(CAKE, USDT, EIGHTEEN_DECIMALS, ELEVEN)
const SEVEN_HUNDRED_USDT_PER_CAKE = new Price(CAKE, USDT, EIGHTEEN_DECIMALS, SEVEN_HUNDRED)
...
describe('limitOrders/utils/getRatePercentageMessage', () => {
  describe.each([
    [
      getRatePercentageDifference(SEVEN_USDT_PER_CAKE, ELEVEN_USDT_PER_CAKE),
      ['57.14% above market', PercentageDirection.ABOVE],
    ],
    [
      getRatePercentageDifference(SEVEN_USDT_PER_CAKE, FIVE_USDT_PER_CAKE),
      ['-28.57% below market', PercentageDirection.BELOW],
    ],
    [
      getRatePercentageDifference(SEVEN_USDT_PER_CAKE, SEVEN_HUNDRED_USDT_PER_CAKE),
      ['9,900% above market', PercentageDirection.ABOVE],
    ],
    [
      getRatePercentageDifference(SEVEN_USDT_PER_CAKE, ONE_USDT_PER_CAKE),
      ['-85.71% below market', PercentageDirection.BELOW],
    ],
    [
      getRatePercentageDifference(SEVEN_USDT_PER_CAKE, SEVEN_USDT_PER_CAKE),
