...
const HarvestCard = () => {
  ...
  const earningsUsdt = new BigNumber(farmEarningsSum).multipliedBy(cakePriceUsdt)
  ...
  const earningsText = getEarningsText(numFarmsToCollect, hasCakePoolToCollect, earningsUsdt, t)
